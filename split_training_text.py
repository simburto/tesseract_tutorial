...
output_directory = 'tesstrain/data/NFS-ground-truth'
...
for line in lines:
    ...
    with open(line_training_text, 'w', encoding='utf-8') as output_file:
        output_file.write(line)  # Use write instead of writelines

    file_base_name = f'eng_{line_count}'

    subprocess.run([
        r'C:\Program Files\Tesseract-OCR\text2image',
        f'--font=NFS font Regular',
